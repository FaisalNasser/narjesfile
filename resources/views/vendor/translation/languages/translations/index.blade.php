            ...
            <div class="panel-body">
                ...
                @if(count($translations))
                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                <th class="w-1/5 uppercase font-thin">{{--{{ __('translation::translation.group_single') }}--}}@lang('site.group_single')</th>
                                <th class="w-1/5 uppercase font-thin">{{--{{ __('translation::translation.key') }}--}}@lang('site.key')</th>
