    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <div style="background: #00b050; text-align: center;  width: -webkit-fill-available;">
                <p style="padding: 0px;  text-align: center;   font-family: 'Tajawal'; margin-top: 14px; color: #ffffff; font-size: 16px;  font-weight: bold;  margin-right: 10px; direction: ltr;">  Vielen Dank für Ihre Registrierung bei Narjes Alsham Shop!        </p>
            </div>
          </td>
		                ...
		                <td valign="middle" width="50%">
		                  <div class="text-blog" style="text-align: left; padding-left:25px;">
                                <p style="font-family: 'Tajawal';  font-size: 16px;   color: black;">Lieber <span style="font-weight: bold; direction: ltr;"> {{ $content['message'] }}</span>,  </p>
				              	...
				              	<p style="font-family: 'Tajawal';  font-size: 16px; color: black;">wir freuen uns, dass Sie sich mit der E-Mail Adresse <span><a href="#">{{ $content['email'] }}</a></span>  com für ein My Narjes Alsham Shop-Konto registriert haben.
        Bitte kopieren Sie den Code
            Und indem Sie auf die Schaltfläche unten klicken, um Ihre Registrierung zu bestätigen, können Sie sich mit Ihrem Mein <a href="#">Narjes Alsham-Konto</a>  auf <a href="http://www.narjes-alsham.com">www.narjes-alsham.com</a> anmelden.</p>
                                    <p  style="font-family: 'Tajawal';  font-size: 16px; color: black;">Code :<span style="font-weight: bold;"> {{$content['code']}}</span> </p>
                                    <?php  $url = url("/validationcode/".$content['email']);?>
                                 
				              	<p  style="text-align: center;" ><a href="<?php echo $url; ?>"  class="btn btn-primary">Registrierung bestätigen</a></p>
		                  </div>
		                </td>
          				</table>
          			</td>
              ...
              <tr>
          			<td style="padding-bottom: 30px;">
		                ...
		                <td valign="middle" width="50%">
		                  <div class="text-blog" style="text-align: left; padding-left:25px;">
				              	<p  style="font-family: 'Tajawal';  font-size: 16px; color: black;" >Vielen Dank für Ihre Registrierung auf unserer Webseite. Wir hoffen, dass Sie bei uns das finden werden, wonach Sie suchen, und dass Sie mit unseren hochwertigen und natürlichen Produkten zufrieden sein werden.
                                    Herzliche Grüße
                                    </p>
