    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <div style="background: #00b050; text-align: center;  width: -webkit-fill-available;">
                <p style="padding: 0px;     font-family: 'Tajawal'; margin-top: 14px; color: #ffffff; font-size: 16px;  font-weight: bold;  margin-right: 10px; direction: ltr;">Neue Kontaktnachricht!</p>
            </div>
          </td>
	        		...
	        		<tr>
          			<td >
		                ...
		                <td valign="middle" width="50%">
		                  <div class="text-blog" style="text-align: left; padding-left:14px; direction: ltr;">
                          
						  <div class="content">
								<p>Hallo Admin. Jemand möchte reden</p>
								<p> 
								Name : {{$content['name']}}
								</p>
