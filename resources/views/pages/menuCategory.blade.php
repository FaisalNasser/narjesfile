...
<div class="cat__fixed__menu" style="" dir="auto">
    <div class="container  arrow__container">
        ...
        <div class="cat__conatiner">
            <!-- cat item -->
            <div class="cat__item  fil-cat" data-rel="all">
                <div class="cat__icon">
            ...
            <!-- endding cat item -->
                        <input value="{{ $id }}" hidden id="ValueId"/>

            @foreach($categories as $cat)
            @if ($id!=0)
            @if ($id == $cat->id)
            <div class="cat__item active fil-cat" data-rel="{{$cat->id}}" data-cid="$id">
                <div class="cat__icon">
                  @if(!empty($cat->icon))
    ...
    <div class="container">
        <div class="our-menu-details" style="">
            <div class="row" style=" justify-content: center;">
                ...
                <!-- Start: Our-menu-one -->
                <div class="col-xs-12 col-sm-12 col-lg-9" id="portfolio">
                    <div class="row">
                        @foreach($categories as $cat)
                        ...
                        <div class="{{$pro->category_id}} menu-item-block col-6 col-sm-6 col-md-4 col-lg-4">
                            ...
                            <div class="price-controler">
                                ...
                                <div class="my-add-to-cart AddToCart" style="cursor:pointer;"
                                    data-price="{{$prices[$key]}}" data-id="{{$pro->id}}" 
                                    data-key="{{$key}}"
                                    data-size="{{$t}}"
                                    data-name="{{$pro->name}}">
            ...
            <div class="" style="margin-bottom : 10px display:flex; justify-content: center;">
                ...
                <div class="bg-grey menu-list no-pad order-summary-widget">
                    ...
                    <h5 class="orange">@lang('site.Your_Order') <i class="fa fa-shopping-cart white pull-right"></i>
                     <i id="up" class="fa fa-arrow-down  white pull-left show showMe "></i>
                    </h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body col-sm-12">
                ...
                {{--<div class="col-sm-6 col-lg-6 form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="@lang('site.email')">
                    </div>--}}
...
$("body").on("click", ".ConfirmOrder", function() {
    ...
    if (cart.length < 1) {
        swal("", "لم تقم بطلب أي منتج", "error");
        return false;
    }
    var name = $("#name").val();
    var email = $("#email").val();
    ...
    var form_data = {
        ...
        type: "order",
        status: 2,
          delivery_cost: <?php echo setting_by_key("delivary"); ?>, 
    ...
    if (cart.length > 0) {
        ...
        $.each(obj, function(key, value) {
            ...
            cart_html +=
                ...
                ' <i class="fa my-icons fa-trash fa-lg DeleteItem" data-id=' + value.id +
                '></i></span></li>';
