...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li class="active">@lang('site.Payment')</li>
    </ul><!-- /.breadcrumb -->
...
<br> <br>
            ...
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        <h3 class="panel-title display-td" >@lang('site.Payment_Details')</h3>
                        ...
                        <div class="row">
                            <div class="col-xs-7 col-md-7">
                                <div class="form-inline">
                                    <label for="cardExpiry"><span class="hidden-xs">@lang('site.EXPIRATION')</span><span class="visible-xs-inline">EXP</span> DATE</label>
                            ...
                            <div class="col-xs-5 col-md-5 pull-right">
                                <div class="form-group">
                                    <label for="cardCVC">@lang('site.CV_CODE')</label>
        ...
        <div class="col-xs-12 col-md-7" style="font-size: 12pt; line-height: 2em;">
            <p><h3>@lang('site.Details')</h3>
                <ul>
                    <li><strong>@lang('site.amount') :</strong> <?php echo $setting->currency . $setting->featured_price;?></li>
                    <li><strong>@lang('site.Property') :</strong> <?php echo $property->title;?></li>
                    <li><strong>@lang('site.address') : </strong><?php echo $property->address;?></li>
