<link href="{{ asset('adminpanel/assets/dist/cropper.css')}}" rel="stylesheet">
  <script src="{{ asset('adminpanel/assets/dist/cropper.js') }}"></script>
<style> 
...
$("body").on("click" , "#Save" , function() {
	...
	$.ajax({
				url: "<?php echo url('category/upload_photo_crop'); ?>", // Url to which the request is send
                type: "POST",
...
$(document).on("change","#cropper",function() {
       var imagecheck=$(this).data('imagecheck'),
           ...
           img.onload = function() {
            if(this.width <145 || this.height<145){
                swal('','@lang("profile.profile_picture_size_message")','error');
                return false;
            }
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('site.Product_Photo')</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id="loader"></button>
          ...
          <input type="button" class="btn btn-primary" id="Save" value="Save Image">
