            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
						...
						<a href="{{ url('users/create') }}" class="btn btn-primary btn-xs">@lang('site.add_new')</a>
                    ...
                    @if(!empty($user->role->display_name))
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('users/' . $user->id . '/edit') }}" class="btn btn-primary btn-xs pull-right">@lang('site.edit')</a>
                            </td>
                        </tr>
                    @endif
                    @empty
