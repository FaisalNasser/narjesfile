...
<div class="ibox-content">
            ...
            <tbody>
                <?php if(!empty($sliders)) { foreach ($sliders as $row) { ?>
                    <tr id="{{$row->id}}">
                        ...
                        <td><?php echo $row->title; ?></td>
                         <td> 
                            <a data-id="{{$row->id}}" class="edit" href="<?php echo url("slider/edit/" . $row->id); ?>" > <i class="fa fa-edit"> </i> </a>
                ...
                <tr>
                    <td rowspan=4> @lang('site.No_Slider_Found') </td>
                </tr>
<?php } ?>
            ...
            <form role="form" action="<?php echo url("slider/save"); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label> Name</label>
                     <textarea class="form-control summernote" required type="text" id="title" name="title"></textarea>
