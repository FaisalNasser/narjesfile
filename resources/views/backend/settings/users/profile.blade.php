...
<div class="panel panel-default">
    <div class="panel-heading">@lang('site.user_profile')</div>
    ...
    <div class="panel-body">
		...
		@endif
            ...
            <div class="form-group">
                ...
                <a class="btn btn-link" href="{{ url('profile') }}">@lang('site.cancel')</a>
				<input type="button" data-toggle="modal" data-target="#resetPasswordModal" class="btn btn-primary pull-right" value="@lang('site.reset_password')">
            </div>
        </form>
    </div>
</div>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">@lang('site.reset_password')</h4>
      </div>
      <div class="modal-body">
		  	<div class="form-group">
			  <label class="font-14px">@lang('site.old_password')</label>
			  <input type="password" id="user_password_pass"  class="form-control notreadonly">
		  </div>
     		<div class="form-group">
			  <label class="font-14px">@lang('site.new_password')</label>
			  <input type="password" id="new_password" class="form-control notreadonly">
		  </div>
     <div class="form-group">
			  <label class="font-14px">@lang('site.confirm_new_password')</label>
			  <input type="password" id="confirm_password"  class="form-control notreadonly">
		  </div>
      </div>
      <div class="modal-footer">
        <button type="button" id="Update_Password" data-id="pass" class="btn btn-primary">@lang('site.update')</button>
      </div>
    </div>
  </div>
</div>
