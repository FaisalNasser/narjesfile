            ...
            <div class="ibox-content p-xl">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-12">
                            ...
                            <address>
                                ...
                                <br>
                                Address : {{ $sale->address }}<br>
                                <abbr title="Phone">Phone :</abbr> {{ $sale->phone }}<br>
                                <abbr title="Email">Email :</abbr> {{ $sale->email }}
                            </address>
                        </div>
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <h4 class="text-navy"><a href="{{ url('sales/receipt/' . $sale->id) }}"> {{ $sale->invoice_no }}</a>
                        </h4>
                        <p>
                            <span><strong>@lang('site.Table_number'):</strong> {{ $sale->table_id }}</span><br />
                        </p>
                        <p>
