                    ...
                    <div class="main-menu d-none d-lg-block headertop-dropdown-container ">
                        <nav style="text-align: center; direction: rtl;">
                            <ul style="margin: 0px">
                                ...
                                <li><a class="single-category-Headeritem cath-{{$category->id}} single-category-item  item_active_header @if ($loop->first) {{ 'headeractive' }} @endif " data-header="true" data-rel="{{ $category->id }}" data-name="@if (!empty($category->translation->name))
